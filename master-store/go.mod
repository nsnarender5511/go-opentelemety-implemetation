module github.com/narender/master-store

go 1.24

// Point to the local common module
replace github.com/narender/common => ../common
...
// Add the dependency on the common module
require github.com/narender/common v0.0.0
