...
**Related Pages:** ./Telemetry_Setup.md, ./Logging_Details.md, ./Tracing_Details.md, ./Key_Metrics.md, ./SigNoz_Dashboards.md, [`common/telemetry/attributes/attributes.go`](../../common/telemetry/attributes/attributes.go)
...
*   **Traces:** Distributed traces track requests as they flow through services. See ./Tracing_Details.md.
*   **Metrics:** Quantitative measurements of application performance and resource usage. See ./Key_Metrics.md.
*   **Logs:** Structured logs provide contextual information about events. See ./Logging_Details.md.
...
*   **Backend & Visualization:** SigNoz Cloud (See ./SigNoz_Dashboards.md)

---

## 5. Visuals & Diagrams

See ./Telemetry_Setup.md for a diagram of the overall telemetry pipeline.
...
*   **Demo Steps:**
    ...
    2.  Show the ./Telemetry_Setup.md page and diagram.
    3.  Navigate to ./SigNoz_Dashboards.md (once populated) and show examples of traces, metrics (dashboards), and logs, explaining how they correlate.
